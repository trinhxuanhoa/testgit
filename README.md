...
- ![](demo/cong.png) : tăng chỉ số của một thành phần trong game.

- ![](demo/tru.png) : giảm chỉ số của một thành phần trong game.

- ![](demo/yes.png) : bật quái.

- ![](demo/no.png) : tắt quái.
